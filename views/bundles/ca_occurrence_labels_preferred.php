...
?>
	...
	<div class="bundleContainer">
		...
		<div class='button labelInfo caAddLabelButton' style="margin-left: 10px;"><a href='#'><?php print caNavIcon(__CA_NAV_ICON_ADD__, '15px'); ?> <?php print $vs_add_label ? $vs_add_label : _t("Add label"); ?></a></div>
	</div>
