...
?>
	<textarea class='caLabelTemplate' style='display: none;'>
		<div id="{fieldNamePrefix}Label_{n}" class="labelInfo">
			<div class="caDeleteLabel">
				<a href="#" class="caDeleteLabelButton"><?php print caNavIcon(__CA_NAV_ICON_DEL_BUNDLE__, 1, null, null, array('graphicsPath' => $this->getVar('graphicsPath'))); ?></a>
			</div>
			
			<?php print $t_label->htmlFormElement('name', "^ELEMENT", array_merge($va_settings, array('request' => $this->request, 'name' => "{fieldNamePrefix}name_{n}", 'id' => "{fieldNamePrefix}name_{n}", "value" => "{{name}}", 'no_tooltips' => true, 'textAreaTagName' => 'textentry', 'readonly' => $vb_read_only))); ?>
			<br/>
	...
	<div class="bundleContainer">
		...
		<div class="button labelInfo caAddLabelButton"><a href='#'><?php print caNavIcon(__CA_NAV_ICON_ADD__, '15px', null, null, array('graphicsPath' => $this->getVar('graphicsPath'))); ?> <?php print $vs_add_label ? $vs_add_label : _t("Add label"); ?></a></div>
	</div>
