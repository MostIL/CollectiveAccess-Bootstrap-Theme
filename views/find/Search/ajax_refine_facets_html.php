 ...
 */
	...
	if (sizeof($va_available_facets)) {
		...
		foreach($va_available_facets as $vs_facet_code => $va_facet_info) {
			$c++;
?>		
			<a href='#' class="list-group-item list-group-item-action" onclick='$("#searchRefineBox").slideUp(200); caUIBrowsePanel.showBrowsePanel("<?php print $vs_facet_code;?>")'><?php print $va_facet_info['label_plural'];?></a>
<?php		
		}
	} else {
