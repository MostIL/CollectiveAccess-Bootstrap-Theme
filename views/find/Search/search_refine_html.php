...
?>
		<div id="searchRefineBox">
			<div class="bg">
				<a href='#' id="hideRefine" onclick='return caHandleResultsUIBoxes("refine", "hide");'><?php print caNavIcon(__CA_NAV_ICON_CLOSE__); ?></a>
				<div id="searchRefineContent"><?php print caNavIcon(__CA_NAV_ICON_SPINNER__, '24px'); ?></div>
