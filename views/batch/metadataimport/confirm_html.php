...
<script type="text/javascript">
	...
	function caExecuteBatch() {
		...
		$("#caConfirmBatchExecutionPanelContentArea").hide();
		$("#caConfirmBatchExecutionPanel").append('<div style="text-align: center; padding: 15px;"><i class="fa fa-spinner fa-spin" style="font-size:60px;/* margin: auto; */"></i></div>');
	}
</script>
